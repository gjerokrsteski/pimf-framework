...
class ResolverTest extends PHPUnit_Framework_TestCase
{
  ...
  public function testLoadingControllerInstance()
  {
    ...
    $this->assertInstanceOf('\Pimf\Controller\Base', $resolver->process(self::$env, self::$logger, self::$em));
  }
  ...
  public function testCallingControllerAction()
  {
    ...
    $this->assertEquals(
      ...
      $resolver->process(self::$env, self::$logger, self::$em)->render()
  ...
  public function testCallingControllerActionByHttpMethodPut()
  {
    ...
    $this->assertEquals(
      ...
      $resolver->process(new \Pimf\Environment($_MY_SERVER), self::$logger, self::$em)->render()
  ...
  public function testIfCanNotLoadClassControllerFromRepository()
  {
    ...
    $resolver->process(self::$env, self::$logger, self::$em);
  ...
  public function testIfAppCanRedirect()
  {
    ...
    $resolver->process(self::$env, self::$logger, self::$em)->redirect('index/index', false, false);
