...
class LoggerTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        new \Pimf\Logger(
            new \Pimf\Adapter\File(self::$localeStorageDir, "pimf-logs.txt"),
    ...
    public function testLoggingMethodsIntoFile()
    {
        $logger = new \Pimf\Logger(
            new \Pimf\Adapter\File(self::$localeStorageDir, "pimf-logs.txt"),
            new \Pimf\Adapter\File(self::$localeStorageDir, "pimf-warnings.txt"),
    ...
    public function testLoggingMethodsUnbufferedToStdOut()
    {
        $logger = new \Pimf\Logger(
            new \Pimf\Adapter\Std(\Pimf\Adapter\Std::OUT),
            new \Pimf\Adapter\Std(\Pimf\Adapter\Std::OUT),
            new \Pimf\Adapter\Std(\Pimf\Adapter\Std::ERR)
        );
        $logger->init();
